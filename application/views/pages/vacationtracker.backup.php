			  ...
			  for($i=1;$i<=$thismonth_noofdays;$i++)
				{
					...
					if(isset($ccc) && $ccc > 0) {
					if(in_array($dateformated, $datesperperson[$person])){
						
						$vacdetails.= "<div class='datecolumns highlighted'></div>";
					}
					else {
						$vacdetails.= "<div class='datecolumns'></div>";
					}
					}
					else {
						$vacdetails.= "<div class='datecolumns'></div>";
				...
				for($i=1;$i<=$nextmonth_noofdays;$i++)
				{
					...
					$dateformated2 = $y2.'-'.$m2.'-'.$day2;
						if(isset($ccc) && $ccc > 0) {
					if(in_array($dateformated2, $datesperperson[$person])){
