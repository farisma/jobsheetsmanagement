	...
	?>	
	  ...
	  foreach($listofrequests as $rows) {
		...
		<tr>
			...
			<td><?php if($rows['approved'] == 'n') { echo "Not Approved"; } else if($rows['approved'] == 'r') {echo "Rejected";} else echo "Approved";?></td>
			<td><?php if($rows['approved'] == 'n') {?><a href="<?php echo site_url('vacation/approveleave/'.$rows['id'].'/'.$rows['employee_id']) ?>">Approve</a><?php } else if($rows['approved'] == 'r') {?> <a href="<?php echo site_url('vacation/approveleave/'.$rows['id'].'/'.$rows['employee_id']) ?>">Approve</a><?php } else {?>  <a href="#">Approved</a><?php } ?></td>
			<td><?php if($rows['approved'] == 'n') {?><a href="<?php echo site_url('vacation/rejectleave/'.$rows['id'].'/'.$rows['employee_id']) ?>">&nbsp;&nbsp;Reject<?php }?></td>
			<td><a href="<?php echo site_url('vacation/deleteleave/'.$rows['id'].'/'.$rows['employee_id']) ?>">Delete</td>
			<td><?php if(isset($rows['rejectremarks']) && $rows['approved'] == 'r') echo $rows['rejectremarks'];?></td>
		</tr>
				<?php
			}	
