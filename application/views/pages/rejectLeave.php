...
<?php if(isset($message)) {
	if($message == "true") { ?> <div class="alert"> <?php echo "Leave request has been rejected. A message is sent to the employee.";?></div> 
	<?php }
	else { ?> <div class="alert"> <?php echo "Leave hasn't been rejected.";?></div>
	<?php 
