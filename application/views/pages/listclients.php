...
<tr>
    ...
    <th>Client</th>
    <th>Active</th>
    <th>Consolidated billing required(Retainers)</th>
    <th>Action</th>
</tr>
...
<tr>
    ...
    <td colspan="1"><?php  echo ($row["enabled"]=='y')?'Yes':'No';?></td>
    <td><?php  echo ($row["consolidated_billing_for_retainer"]=='y')?'Yes':'No';?></td>
    <td><a href="<?php echo site_url('edit-client/'. $jobsheetid); ?>">Edit</a>/<a href="<?php echo site_url('delete-client/'. $jobsheetid); ?>">Disable</a></td>
</tr>
<?php 
$i++;}
?>
