  ...
  <div class="hero-unit">
    <ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
          ...
          <li><a href="#statusreport" data-toggle="tab">Open Jobs Report</a></li>		
    </ul>
...
<?php   if(isset($jobs)) {
    if(isset($jobsearchparams)) {
      //these vaariables are for populating hidden variables that is used in exporting report function
  ...
  ?>
   ...
   <input type="hidden" name="hiddenyear" value="<?php  if(isset($year)) echo  $year;?>">
	<?php 
  //list of closed jobs in retainer and consolidated job numbers
	...
	<?php }
  //list of closed jobs in non-retainer job numbers
...
<?php }
  ...
  <?php 
   if(isset($alljobs)) {
    if(isset($alljobsearchparams)) {
      ...
      {
        //list of open jobs in retainer and consolidated job numbers
  ...
  {
    //list of all open jobs nonretainer jobs
