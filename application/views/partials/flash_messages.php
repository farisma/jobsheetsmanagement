...
<?php if ($notadminwarning = $this->session->flashdata('notadmin')): ?>
<div class="alert alert-error"><button type="button" class="close" data-dismiss="alert">&times;</button><?php echo $notadminwarning ?></div>
<?php endif ?>
