...
$db['development']['password'] = 'wKN5mSUjvb1w';
// $db['development']['database'] = 'andonjobsheetsapp';
$db['development']['database'] = 'jobsheettest';
...
$db['staging']['password'] = 'wKN5mSUjvb1w';
$db['staging']['database'] = 'andonjobsheetsapp';
...
$db['production']['password'] = 'wKN5mSUjvb1w';
$db['production']['database'] = 'andonjobsheetsapp';
